      ...
      if (currentMessage == previousMessage) {
          ...
          if ((dayOfWeek != 5 && dayOfWeek != 6) || (currentMonth == 8 || currentMonth == 1)) {
              ...
              for (const string& period_time_item : classes_period_time_array) {
                  ...
                  if (((hour == currentHour) || 
                     (hour == (currentHour + 1) % 24 && currentMinute + minuteMargin >= 60) ||
                     (hour == (currentHour - 1 + 24) % 24 && currentMinute - minuteMargin < 0)) &&
                     ((minute > currentMinute && minute - currentMinute <= minuteMargin) || 
                     (minute == currentMinute && second > currentSecond && second - currentSecond <= secondMargin) || 
                     (minute > currentMinute && secondMargin > 0 && second >= currentSecond))) {
